...
Link Otomasinya disini (https://reactandgo.herokuapp.com/)[https://reactandgo.herokuapp.com/]

Pelajari cara membuat aplikasi satu halaman di React, dengan data yang disediakan oleh REST API Go back end
terdiri dari:
## Langkahnya
- [ ] Pendahuluan
- [ ] Mempersiapkan development
- [ ] Memulai ngoding standar
...
## Membangun Front End
- [ ] Setting Go Back end REST API
- [ ] Connecting ke REST API
- [ ] Membuat Form, React dan GO Lang
- [ ] Tambah GraphQL ke dalam persamaan
- [ ] Masukan ke Server
- [ ] Conversi menggunakan REACT HOOKS
